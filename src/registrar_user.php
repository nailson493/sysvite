    ...
    <div class="p-4 border-dashed rounded-lg dark:border-gray-700 mt-14">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                <p class="text-lg font-medium text-gray-900 dark:text-white">Registrar Usuarios</p>
            </div>
            <!-- Modal body -->
                            ...
                            <div class="lg:col-span-2">
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                    <div class="md:col-span-3">
                                        ...
                                        <input type="text" name="nome" id="nome" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50 border-green-500" value="" />
                                    </div>
                                    <div class="md:col-span-2">
                                        <label for="email">CPF</label>
                                        <input type="text" name="idt" id="cpf" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50 border-green-500" />
                                    </div>
                                    <div class="md:col-span-2">
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <input type="text" name="cidade" id="cidade" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" placeholder="" />
                                    </div>
                                    <div class="md:col-span-1">
                                        <label for="city">Estado</label>
                                        <input type="text" name="uf" id="uf" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" placeholder="" />
                                    </div>
                                    <div class="md:col-span-2">
                                        <label for="country">Telefone</label>
                                        <input type="text" name="tel" id="tel" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" placeholder="" />
                                    </div>
                                    <div class="md:col-span-3">
                                        <label for="state">Sexo</label>
                                        <select name="sexo" id="countries" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50">
...
document.addEventListener("DOMContentLoaded", function() {
    // Verifica se o elemento da câmera e o formulário estão presentes na página
    if (document.getElementById('camera') && document.getElementById('photo-form')) {
